...
!PRINT*, 'down'
!PRINT*, radout%flux_down(1,:,1)



! set heating rates and diagnostics
do l=1, n_profile
!radout%flux_down(l,40,1) = 1.001*radout%flux_down(l,39,1)
!radout%flux_up(l,10:,1) = 1000.0!1.001*radout%flux_up(l,37,1)

!radout%flux_up(l,39,1) = 0.999*radout%flux_up(l,40,1)
!radout%flux_up(l,38,1) = 1.001*radout%flux_up(l,37,1)
  do i=1, n_layer
!IF (radout%flux_up(l,i,1) < -1.E6) THEN
!PRINT*, i
!END IF
 ...
 !   heating_rate(l,2) = heating_rate(l,3)
 !   heating_rate(l,1) = heating_rate(l,2)
 !   heating_rate(l,0) = heating_rate(l,1)
 !   heating_rate(l,39) = heating_rate(l,38)
 !   heating_rate(l,40) = heating_rate(l,39)
end do

!PRINT*, 'ook'
!PRINT*, heating_rate(1,:)
