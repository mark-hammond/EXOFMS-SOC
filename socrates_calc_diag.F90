...
! ExoFMS diagnostics:
!real, intent(out) , dimension(:,:)   :: soc_olr
!real(r_def), intent(out) :: soc_olr(:,:)

! Allocate diagnostic fields
!allocate (soc_olr              (ie-is+1, je-js+1))
...
! Set diagnostics
!soc_olr = RESHAPE(radout_flux_up(:,40,1) , (/144,3/))
...
end module socrates_calc_diag_mod
